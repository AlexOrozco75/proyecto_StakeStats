        ...
        <?php if(!empty($peleadores)): ?>
            <?php foreach($peleadores as $fighter): ?>
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card h-100 bg-dark text-white" style="border: 1px solid #2a2a2c; border-radius: 10px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.5);">
                        ...
                        <div class="card-body">
                            <h4 class="card-title fw-bold text-uppercase mb-0" style="font-family: 'Oswald', sans-serif;">
                            ...
                            <ul class="list-group list-group-flush" style="border-top: 1px solid #2a2a2c;">
                                ...
                                <li class="list-group-item bg-transparent text-white d-flex justify-content-between align-items-center px-0 py-2 border-secondary">
                                    ...
                                    <span><?= !empty($fighter['altura_cm']) ? htmlspecialchars($fighter['altura_cm']) . ' cm' : '--' ?></span>
                                </li>
                                <li class="list-group-item bg-transparent text-white d-flex justify-content-between align-items-center px-0 py-2 border-secondary">
